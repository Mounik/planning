...
class PDFGenerator:
    ...
    def generer_pdf_feuille(self, feuille_data: Dict[str, Any]) -> io.BytesIO:
        ...
        for jour in feuille_data["jours_travailles"]:
            ...
            data_jours.append([date_formatee, creneaux_text, f"{jour['heures']}h"])
        ...
        data_heures = [
            ...
            [
                "Heures normales",
                f"{calcul['heures_normales']}h",
                f"{calcul['salaire_normal']:.2f}€",
            ],
            [
                "Heures complémentaires",
                f"{calcul['heures_complementaires']}h",
                f"{calcul['salaire_complementaire']:.2f}€",
            ],
            [
                "Heures complémentaires majorées",
                f"{calcul['heures_complementaires_majorees']}h",
                f"{calcul['salaire_complementaire_majore']:.2f}€",
            ],
            [
                "Heures supplémentaires",
                f"{calcul.get('total_heures_supplementaires', 0)}h",
